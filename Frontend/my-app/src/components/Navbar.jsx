...
import Login from "../pages/Login";                      //login ce se na drugom mestu desavati posto ce se morati popouniti forma login-a
        ...
        <nav className=" bg-gray-800 text-white p-3 !flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
                {isAuthenticated ? (
                    ...
                    <Link to="/login" className="bg-blue-500 px-3 py-1 rounded-lg">
                        Login
                    </Link>
                )}
            </div>
